...
let s:p.normal.left     = [ [ s:base03, s:base05 ], [ s:base06, s:base04 ] ]
let s:p.insert.left     = [ [ s:base00, s:base0D ], [ s:base06, s:base04 ] ]
let s:p.visual.left     = [ [ s:base00, s:base09 ], [ s:base06, s:base04 ] ]
let s:p.replace.left    = [ [ s:base00, s:base08 ], [ s:base06, s:base04 ] ]
let s:p.inactive.left   = [ [ s:base04, s:base06 ] ]

let s:p.normal.middle   = [ [ s:base02, s:base05 ] ]
let s:p.inactive.middle = [ [ s:base03, s:base06 ] ]

let s:p.normal.right    = [ [ s:base06, s:base04 ], [ s:base01, s:base03 ] ]
...
let g:lightline#colorscheme#base16_light#palette = lightline#colorscheme#flatten(s:p)
